...
export function LandingPage() {
  ...
  return (
    <div className="-mx-4 -mt-4 sm:-mx-6 lg:-mx-8 md:-mb-6">
      ...
      <section className="bg-muted/40">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 grid gap-6 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-border bg-card p-6 text-center shadow-card">
              <CircleAlert className="mx-auto mb-3 h-8 w-8 text-amber-500" />
              <p className="font-display text-3xl font-bold text-foreground">
                3&ndash;5 min
              </p>
              <p className="mt-1 text-sm text-muted-foreground">
            ...
            <div className="divide-y divide-border">
              {ocrFailures.map((row) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-2 text-sm">
                    <span className="mt-0.5 shrink-0 rounded bg-emerald-500/10 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-emerald-600">
                      LLM
                    </span>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-foreground to-foreground/95 p-8 text-white sm:p-12 lg:flex lg:items-center lg:gap-12 lg:p-16">
        ...
        <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              Two things needed: an LLM API key and Google Contacts access.
          ...
          <div className="space-y-8 rounded-2xl border border-border bg-card p-6 shadow-elevated sm:p-8">
            ...
            <div className="rounded-xl bg-muted/60 p-4">
              ...
              <p className="mb-4 text-sm text-muted-foreground">
                Meishi creates contacts and uploads one photo per card. Google
                requires the <code>{getGoogleScope()}</code> scope, so the
                consent screen may mention broader access than used.
              </p>
            ...
            <div className="flex flex-wrap items-center gap-4 border-t border-border pt-6">
              ...
              <span className="text-sm text-muted-foreground">
                Ready when both an LLM provider and Google access are
                configured.
              </span>
            </div>
          </div>
