export const BASE_EXTRACTION_PROMPT = [
  ...
  "Use the following guidelines when populating names:",
  "  * When business card represents names in two languages (e.g. English and Japanese), use the non-Latin text for the primary name fields and the Latin text for the phonetic name fields.",
  "  * Infer first and last name when the card clearly supports that split.",
